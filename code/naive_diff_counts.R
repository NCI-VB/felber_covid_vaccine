...
# Naive Diff Metadata
col.nam <- colnames(df.all)[colnames(df.all) != "Gene"]
...
write.csv(df.all, "../results/naive_diff_counts.csv", row.names = FALSE, quote = FALSE)
write.csv(df.metadata, "../results/naive_diff_metadata.csv", row.names = FALSE, quote = FALSE)
